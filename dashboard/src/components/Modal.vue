<template>
    <div id="defaultModal" tabindex="-1" aria-hidden="true" 
        :class="{'hidden': !show}"
        class="bg-gray-700 bg-opacity-40 overflow-y-auto overflow-x-hidden fixed top-0 right-50 left-50 z-50 w-full md:inset-0 h-modal md:h-full">
        <div class="relative p-4 w-full max-w-2xl h-full  m-auto min-h-screen space-y-11">
            <!-- Modal content -->
